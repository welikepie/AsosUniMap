...
function InfoBubble(opt_options) {
	...
	if (options['arrowTopSize'] == undefined) {
		options['arrowTopSize'] = this.ARROW_SIZE_;
	}
...
InfoBubble.prototype.getArrowTopSize_ = function() {
	return parseInt(this.get('arrowTopSize'), 10) || 0;
};
...
InfoBubble.prototype.arrowPosition_changed = function() {
	...
	this.arrowOuter_.style['left'] = (pos - 2) + 'px'
	this.arrowInner_.style['left'] = pos + 'px';
...
InfoBubble.prototype.updateArrowStyle_ = function() {
	...
	var arrowOuterSize = arrowSize;
	var arrowInnerSize = Math.max(0, arrowSize - borderWidth);
	...
	outer.style['borderTopWidth'] = this.px(arrowOuterSize + 8);
	inner.style['borderTopWidth'] = arrowInnerSizePx;

	// Full arrow or arrow pointing to the left
	if (arrowStyle == 0 || arrowStyle == 1) {
		outer.style['borderLeftWidth'] = this.px(arrowOuterSize);
	...
	if (arrowStyle == 0 || arrowStyle == 2) {
		outer.style['borderRightWidth'] = this.px((arrowSize + 8) / 2);
		inner.style['borderRightWidth'] = this.px(arrowSize / 2);
	} else {
...
InfoBubble.prototype.figureOutSize_ = function() {
	...
	var borderRadius = this.getBorderRadius_();
	var arrowSize = this.getArrowSize_();
	var arrowTopSize = this.getArrowTopSize_();
